...
MODULE : HSTOMC.c
**
ABSTRACT : This module sends signals from the MCU to the DSP
**
...
* HISTORY :
**
1 04-10-04 16:25 Bertil Soderberg
* First version.
...
---------------------------------------------------------------------------
*/
void HSTOMC(TYPE_HSTOMC_IF* data)
{
	hstop = &data->HSTOMZ_Sig1 ; /* area starts with the first signal */
}
